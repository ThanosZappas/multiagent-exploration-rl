...
def main():
    ...
    output_dir = "gym_env/evaluation/final_prediction_logs/MultiChannel"
    ...
    models_info = [
        {
            'name': 'DQN',
            'path': 'gym_env/models/final/DQN_MultiChannel_Final/level_1_final.zip',
            'class': DQN
        },
        {
            'name': 'PPO',
            'path': 'gym_env/models/final/PPO_MultiChannel_Final/level_1_final.zip',
            'class': PPO
        },
        {
            'name': 'A2C',
            'path': 'gym_env/models/final/A2C_MultiChannel_Final/level_1_final.zip',
            'class': A2C
        }
    ]
